      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-xl border-b-2 border-zinc-900">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="block text-sm font-bold tracking-tight text-zinc-900">visionOS</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {LIFE_STAGES.map((stage) => (
              <div
                ...
                className={`cursor-pointer relative p-8 rounded-2xl border-2 transition-all duration-300 group ${lifeStage === stage.id
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className={`p-3 rounded-xl transition-all ${lifeStage === stage.id ? "bg-white/20" : "bg-zinc-100 group-hover:bg-green-50"
                    }`}>
                    {stage.icon}
                  </div>
                  {lifeStage === stage.id && (
            ...
            {AREAS.map((area) => {
              ...
              return (
                <button
                  ...
                  disabled={isDisabled}
                  className={`h-16 px-8 rounded-xl border-2 flex items-center gap-3 font-bold text-base transition-all duration-300 ${isActive
        ...
        <div className="container mx-auto px-6 py-6 max-w-4xl">
          <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2">
                  {[
                    ...
                    <div key={idx} className={`h-2 rounded-full transition-all ${completed ? 'bg-green-600 w-12' : 'bg-zinc-300 w-12'
                      }`} />
                  ))}
                </div>
            ...
            <button
              ...
              className={`group flex items-center gap-4 px-10 h-16 rounded-xl text-lg font-bold transition-all ${isValid && !isSubmitting
